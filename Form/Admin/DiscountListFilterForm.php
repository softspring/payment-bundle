...
class DiscountListFilterForm extends EntityListFilterForm implements DiscountListFilterFormInterface
{
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults([
            ...
            'label_format' => 'admin_discount.list.filter_form.%name%.label',
        ]);
    }
